...
\[Delta]\[CapitalUpsilon]t = 
    (((1 + e)*(2 + 2*e - p)*(3 + e^2 - p)*(-4 + p)^2*p*(-6 + 2*e + p)*
        (-2 + 2*e + p)*EllipticE[(4*e)/(-6 + 2*e + p)]^2)/(6 + 2*e - p) + 
      (-4 + p)*EllipticE[(4*e)/(-6 + 2*e + p)]*
       ...
       ((1 + e)*p*(4*e^6*(-8 + p)*(-1 + p) - (28 + (-12 + p)*p)*
           (-24 + p*(33 + 2*(-7 + p)*p)) - 
          e^4*(416 + p*(-268 + p*(76 + (-15 + p)*p))) + 
          e^2*(-3 + p)*(96 + p*(-124 + p*(56 + (-14 + p)*p))))*
         EllipticK[(4*e)/(-6 + 2*e + p)] + (6 + 2*e - p)*
         (-2*(64 + p*(-136 + 65*p - 6*p^3 + p^4) + e^6*(64 + p*(-40 + 3*p)) + 
            e^4*(-64 + p*(8 + p*(-5 + 4*p))) + 
            e^2*(-64 + p*(168 + p*(-127 + 44*p - 6*p^2))))*
           EllipticPi[(2*e*(-4 + p))/((1 + e)*(-6 + 2*e + p)), 
            (4*e)/(-6 + 2*e + p)] - (-1 + e)*(1 + e)^2*(1 + e^2 - p)*
           (-4 + p)^3*(-2 + 2*e + p)*EllipticPi[(16*e)/(12 + 8*e - 4*e^2 - 
              8*p + p^2), (4*e)/(-6 + 2*e + p)])))/(4*(-1 + e)*(1 + e)^2*
      (-4 + p)^3*(-3 - e^2 + p)^(3/2)*EllipticK[(4*e)/(-6 + 2*e + p)]^2)
